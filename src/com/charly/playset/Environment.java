...
public class Environment {
	 ...
	 * **/
	/*
	 * Two New added for current position of Player(the RABBIT)*/
...
////	special funcs... INVALIDATED!! NO LONGER USED NOW
...
//	UP
	public Environment startMoveUp() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.moveUp(this));
	}
	public Environment stopMoveUp() throws IOException{
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.stopMoveUp(this));
	}
	
//	DOWN
	public Environment startMoveDown() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.moveDown(this));
	}
	public Environment stopMoveDown() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.stopMoveDown(this));
	}
	
//	RIGHT
	public Environment startMoveRight() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.moveRight(this));
	}
	public Environment stopMoveRight() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.stopMoveRight(this));
	}
	
//	LEFT
	public Environment startMoveLeft() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.moveLeft(this));
	}
	public Environment stopMoveLeft() throws IOException {
		Rabbit r = (Rabbit) this.envMap[currentYPos][currentXPos];
		return (r.stopMoveLeft(this));
	}
